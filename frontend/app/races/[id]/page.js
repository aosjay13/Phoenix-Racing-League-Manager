...
// A static shell. Every results table, and the points on it is worked out in the browser (see
// RaceResultsScreen.jsx), so there is nothing for a server render to add — and without
