...
export const SPECS = {
  ...
  races:   { collection: "races", parentField: "season_id", sortField: "round_number",
             ...
             fields: { name: { required: true }, track: {}, track_id: {}, track_logo_url: { image: true }, date: { dateOnly: true },
                       ...
                       // caution flags flew, how many laps ran under them, and
                       // how many times the lead changed hands. Each optional
                       // (0 = unset), read only by the top
                       // of the public results page, and scored by nothing.
                       // See lib/raceStats.js.
                       caution_flags: { number: true }, caution_laps: { number: true },
                       lead_changes: { number: true },
